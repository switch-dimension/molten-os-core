...
If ambiguous, ask once: *"Quick score from what you've shared, full 5-round interview, or re-validate against a previous product-score file?"*
...
- Framework synthesis & bibliography: [`references/research.md`](references/research.md) — **do not** surface author names, book titles, or "what to read next" in user deliverables unless the user explicitly asks for reading recommendations.
